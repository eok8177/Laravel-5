...
<head>
  ...
  <link href="{{ asset('vendor/owlcarousel2/assets/owl.carousel.css') }}" rel="stylesheet">
  <link href="{{ asset('vendor/owlcarousel2/assets/owl.theme.default.min.css') }}" rel="stylesheet">
    ...
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-md-10">
            ...
            <div class="item active">
              <div class="contents text-center">
                ...
                <div class="banner_bottom_btn wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="700ms">
                  <a href="#about" class="js-target-scroll"><i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
            <div class="item">
             <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">Digital Solution for Startups</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it.</p>
          ...
          <div class="item">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">More Than Just a Template</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it.</p>
              <a href="#" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Read More</a>
              <a href="#" class="btn btn-border wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Purchase</a>
              <div class="banner_bottom_btn wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="700ms">
...
<section id="about" class="section">
  ...
  <section id="portfolio" class="section">
    ...
    <div class="container">
      <div class="section-header">
        <h3 class="section-subtitle wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">What We Do</h3>
        <h2 class="section-title wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">Works</h2>
      </div>
      <div class="row">
        <div class="col-md-12">
                  ...
                  <div class="sup-desc-wrap">
                    <div class="sup-desc-inner">
                      <div class="sup-meta-wrap">
                        <a class="sup-title" href="#"><h4>GeckPro</h4></a>
                        <p class="sup-description">Responsive Wordpress Onepage Template</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="portfolio-item">
                ...
                <div class="portfoli-content">
                  <div class="sup-desc-wrap">
                    <div class="sup-desc-inner">
                      <div class="sup-meta-wrap">
                        <a class="sup-title" href="#"><h4>GeckBlog</h4></a>
                        <p class="sup-description">Responsive Wordpress Onepage Template</p>
                      </div>
                    </div>
                  </div>
              ...
              <div class="portfolio-item">
                ...
                <div class="portfoli-content">
                  <div class="sup-desc-wrap">
                    <div class="sup-desc-inner">
                      <div class="sup-meta-wrap">
                        <a class="sup-title" href="#"><h4>Remy</h4></a>
                        <p class="sup-description">Responsive Wordpress Onepage Template</p>
                      </div>
                    </div>
                  </div>
              ...
              <div class="portfolio-item">
                ...
                <div class="portfoli-content">
                  <div class="sup-desc-wrap">
                    <div class="sup-desc-inner">
                      <div class="sup-meta-wrap">
                        <a class="sup-title" href="#"><h4>Coelho</h4></a>
                        <p class="sup-description">Responsive Wordpress Onepage Template</p>
                      </div>
                    </div>
                  </div>
    ...
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-md-10 wow rollIn" data-wow-duration="1000ms" data-wow-delay="300ms">
          ...
          <p class="subtitle">There are many variations of passages of Lorem Ipsum available, but the majority have <br> uffered alteration, by injected humour, or new randomised words.</p>
          ...
          <form id="contactForm">
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <input type="text" placeholder="Your Email Address*" id="email" class="form-control" name="name" required data-error="Please enter your email">
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-md-4">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <div class="box-icon wow fadeInUp" data-wow-duration="1200ms" data-wow-delay="500ms">
            ...
            <p>
              <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="234a4d454c635a4c565147424e424a4d4d424e460d404c4e">[email&#160;protected]</a>
            </p>
          </div>
        </div>
        <div class="col-md-4 col-sm-4">
  ...
  <script src="{{ asset('vendor/owlcarousel2/owl.carousel.min.js') }}"></script>

  <script src="{{ asset('vendor/jquery.nav.js') }}"></script>

  <script src="{{ asset('vendor/smooth-scroll.js') }}"></script>

  <script src="{{ asset('vendor/wow.js') }}"></script>

  <script src="{{ asset('vendor/jquery.waypoints.min.js') }}"></script>
  <script src="{{ asset('vendor/jquery.counterup.min.js') }}"></script>

  <script src="{{ asset('vendor/validator.min.js') }}"></script>
